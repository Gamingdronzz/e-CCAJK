package com.mycca.CustomObjects.ShowcaseView;

/**
 * Created by balpreet on 4/26/2018.
 */
...
//        mPaint.setShadowLayer(radius, 0, dy, 0xFF3D3D3D);
        ...
        mTitleTextView.setBackgroundColor(getResources().getColor(R.color.colorPrimaryLight));
        mTitleTextView.setTypeface(null, Typeface.BOLD);
        addView(mTitleTextView, new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
